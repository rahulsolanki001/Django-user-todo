...
SECRET_KEY = 'django-insecure-kqc_3c)lo5x!)hacnxpp07s#2x_fjh^$^y6*8f-y0)ax&d3c+='
...
#CSRF
CSRF_TRUSTED_ORIGINS = ['http://localhost:3000','http://localhost:7777','http://localhost:7000']
